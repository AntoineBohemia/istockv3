...
const overviewData = [
  { name: "Stock actuel", value: "102", change: 12.5, icon: ShoppingBag },
  { name: "Seuil optimal", value: "110", change: 8.3, icon: ShoppingBag },
  { name: "Seuil d'alerte", value: "50", change: -3.2, icon: ShoppingBag },
  { name: "Note", value: "85%", change: 15.7, icon: ShoppingBag },
];
